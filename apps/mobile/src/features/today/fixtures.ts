...
export const canonicalTodayFixture = Object.freeze({
  ...
  weather: Object.freeze({
    ...
    sunriseTime: '06:42',
    sunsetTime: '19:15',
    hourlyRainProbability: Object.freeze([
      Object.freeze({ label: '6a', probabilityPercent: 15 }),
      Object.freeze({ label: '9a', probabilityPercent: 60 }),
      Object.freeze({ label: '12p', probabilityPercent: 50 }),
      Object.freeze({ label: '3p', probabilityPercent: 25 }),
      Object.freeze({ label: '6p', probabilityPercent: 12 }),
      Object.freeze({ label: '9p', probabilityPercent: 6 }),
    ] as const),
  }),
